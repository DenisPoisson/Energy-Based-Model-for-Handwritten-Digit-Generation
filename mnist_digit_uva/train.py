...
CONFIG = {
    # --- data ---
    "digit_class": None,             # None = all digits | 0..9 = train on ONLY that class
    "batch_size": 128,
    "val_fraction": 0.1,
    "data_root": "./data",
    "img_shape": (1, 28, 28),
    ...
    "cd_steps": 100,               # Langevin steps per training batch (k)
    "cd_step_size": 10,
    ...
    # --- generation ---
    "gen_steps": 500,             # Langevin steps for GENERATION (longer than training)
    "gen_step_size": 10,
    "n_gen_samples": 64,
